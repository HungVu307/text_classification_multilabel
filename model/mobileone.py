...
from dataset.dataset import LetterBox
...
class MobileOne(nn.Module):
    ...
    def __init__(self,
        ...
        self.class_name_dict = {'check': 0, 'hw': 1, 'pr': 2, 'signature': 3}
    ...
    def predict_batch(self, images):
        ...
        return [self.id2name[pr] for pr in preds], probs
